...
You can save compute resources by stopping the execution of Jobs that are no longer needed. If that Job is currently running on a Worker, then the associated Rscript background process is terminated, and a replacement process is spun up to take its place in the Worker pool.
